...
PERFORMANCE_PROFILES = {
    "balanced": {
        "description": "Good default for most PCs: stable IPS without overheating weak laptops.",
        "general_config": {
            "cpu_or_gpu": "auto",
            "max_ips": 24,
            "scrcpy_max_fps": 30,
    ...
    "quality": {
        "description": "Sharper capture for strong PCs; use only if IPS stays stable.",
        "general_config": {
            "cpu_or_gpu": "auto",
            "max_ips": 24,
            "scrcpy_max_fps": 30,
