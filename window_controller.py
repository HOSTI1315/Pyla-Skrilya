...
# _serial_port / _is_local_adb_serial moved to adb_serial.py so the unit tests
# can import them without pulling scrcpy/opencv/adb-shell into the test env.
# Re-exported here for the rest of the codebase that already imports from
# window_controller.
from adb_serial import _serial_port, _is_local_adb_serial  # noqa: E402,F401
